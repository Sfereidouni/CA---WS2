...
public class VoxelDeleted : MonoBehaviour
{
    ...
    private Voxel[] neighbors3dJS = new Voxel[20];
    ...
    //Set 3d Moores Neighborhood Density 
    public void setDensity3dJS(int _density3dJS)
    {
        density3dJS = _density3dJS;
    }
    //Get 3d Moores Neighborhood Density 
    public int getDensity3dJS()
    {
        return density3dJS;
    }
    ...
    public void setNeighbors3dJS(Voxel[] _setNeighbors3dJS)
    {
        neighbors3dJS = _setNeighbors3dJS;
    }

    public Voxel[] GetNeighbors3dJS()
    {
        return neighbors3dJS; 
    }
    ...
    public void VoxelDisplayDensity3dMO(int _maxdensity3dMO)
    {
        if (state == 1)
        {
            ...
            //two colors to interpolate between
            Color color1 = new Color(0, 1, 1, 1);
